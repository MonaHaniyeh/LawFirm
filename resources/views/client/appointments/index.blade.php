...
@section('content')
    ...
    ========================================================== --}}
        @if ($errors->any())
            <div class="rounded-xl border border-[#efd7d5] bg-[#fcf3f2] px-5 py-4">
    ...
    ========================================================== --}}
        ...
        ====================================================== --}}
            <div
                    ...
                    <div class="flex items-start justify-between gap-4">
                        ...
                        <div>
                            ...
                            <div class="mb-2 flex items-center gap-2">
                                ...
                                <span class="text-[9px] font-semibold uppercase tracking-[0.2em] text-[#b69a68]">
                                    Schedule
                                </span>
                            </div>
                        ...
                        {{-- Calendar Icon --}}
                        <div class="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-[#f7f4ed]">
                            <svg class="h-5 w-5 text-[#927849]" fill="none" stroke="currentColor" stroke-width="1.5"
                                viewBox="0 0 24 24">
                ...
                FORM
            ================================================== --}}
                <form method="POST" action="{{ route('client.appointments.store') }}" class="space-y-5 px-7 py-7">
                ...
                ================================================== --}}
                    <div>
                        ...
                        <div class="relative">
                            ...
                            {{-- Dropdown Arrow --}}
                            <svg class="pointer-events-none absolute right-4 top-1/2 h-4 w-4 -translate-y-1/2 text-[#7d7b76]"
                ...
                ================================================== --}}
                    <div>
                        ...
                        <input id="location" type="text" name="location" value="{{ old('location') }}"
                            placeholder="Office, phone call, or online meeting" required
                ...
                ================================================== --}}
                    <div>
                        ...
                        <textarea id="note" name="note" rows="4" placeholder="Briefly describe what you would like to discuss..."
                            class="w-full resize-none rounded-xl border border-[#e7e3db] bg-[#faf9f6] px-4 py-3.5 text-sm leading-6 text-[#151515] placeholder:text-[#aaa69e] outline-none transition focus:border-[#b69a68] focus:bg-white focus:ring-2 focus:ring-[#b69a68]/10">{{ old('note') }}</textarea>
                    ...
                    ACTION
                ================================================== --}}
                    <div class="flex items-center justify-between gap-4 border-t border-[#eeeae2] pt-5">

                        <p class="hidden text-[11px] leading-5 text-[#99958e] sm:block">
        ...
        ====================================================== --}}
            <div
                ...
                {{-- Header --}}
                <div class="flex items-center justify-between border-b border-[#e7e3db] px-7 py-6">
            ...
            ================================================== --}}
                <div class="px-7 py-6">
                    ...
                    @forelse ($appointments as $appointment)
                        ...
                        TIMELINE ITEM
                    ================================================== --}}
                        <div class="relative flex gap-5 {{ !$loop->last ? 'pb-7' : '' }}">
                            ...
                            <div class="relative flex w-12 shrink-0 flex-col items-center">
                                ...
                                <div
                                    ...
                                    <svg class="h-4 w-4 text-[#927849]" fill="none" stroke="currentColor"
                                ...
                                @if (!$loop->last)
                                    <div class="absolute top-10 h-full w-px bg-[#e7e3db]"></div>
                                @endif
                            ...
                            APPOINTMENT CARD
                        ================================================== --}}
                            <div class="min-w-0 flex-1 rounded-xl border border-[#e7e3db] bg-[#faf9f6] p-5">
                                ...
                                <div class="flex flex-wrap items-start justify-between gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="font-serif text-xl font-semibold text-[#151515]">
                                ...
                                DETAILS
                            ================================================== --}}
                                <div class="mt-5 space-y-3 border-t border-[#e7e3db] pt-4">
                                    ...
                                    @if ($appointment->lawyer)
                                        <div class="flex items-center gap-3">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-[10px] uppercase tracking-[0.1em] text-[#99958e]">
                                                    Lawyer
                                                </p>

                                                <p class="text-sm font-medium text-[#151515]">
                                    ...
                                    @if ($appointment->case)
                                        <div class="flex items-center gap-3">
                                            ...
                                            <div class="min-w-0">
                                                ...
                                                {{-- CASE NUMBER --}}
                                                <p class="truncate text-sm font-medium text-[#151515]"
...
================================================== --}}
                                @if ($appointment->note)
                                    <div
                                        ...
                                        <p class="text-[10px] font-semibold uppercase tracking-[0.1em] text-[#99958e]">
                                            Your Note
                                        </p>

                                        <p
                                            class="mt-1 w-full min-w-0 max-w-full whitespace-pre-wrap break-all text-xs leading-5 text-[#65635e]">
                                            {{ $appointment->note }}
                                        </p>
...
================================================== --}}
                                @if ($appointment->response)
                                    <div
                                        ...
                                        <p class="text-[10px] font-semibold uppercase tracking-[0.1em] text-[#927849]">
                                            Lawyer's Response
                                        </p>

                                        <p
                                            class="mt-1 w-full min-w-0 max-w-full whitespace-pre-wrap break-all text-xs leading-5 text-[#5f5d58]">

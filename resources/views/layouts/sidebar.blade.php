    ...
    <nav class="sidebar-nav">
        ...
        @if ($role === 'admin')
                ...
                @if (Route::has('admin.communication.index'))
                    ...
                    >
                        <span class="nav-icon">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round">
                                <path d="M4 5.5A2.5 2.5 0 0 1 6.5 3h11A2.5 2.5 0 0 1 20 5.5v8a2.5 2.5 0 0 1-2.5 2.5H10l-5 4v-4.5a2.5 2.5 0 0 1-1-2z"/>
                                <path d="M8 8h8"/>
                                <path d="M8 12h5"/>
                            </svg>
                        </span>
            ...
            <div class="nav-section">
                ...
                @if (Route::has('admin.settings.edit'))
                    ...
                    >
                        <span class="nav-icon">
                            <svg viewBox="0 0 262.394 262.394" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        @elseif ($role === 'lawyer')
            ...
            <div class="nav-section">
                ...
                @if (Route::has('lawyer.settings.edit'))
                    <a
                        href="{{ route('lawyer.settings.edit') }}"
                ...
                @if (Route::has('lawyer.password.edit'))
                    <a
                        href="{{ route('lawyer.password.edit') }}"
        ...
        @elseif ($role === 'client')
            ...
            <div class="nav-section">
                ...
                @if (Route::has('client.settings.edit'))
                    <a
                        href="{{ route('client.settings.edit') }}"
        ...
        @elseif ($role === 'accountant')
            ...
            <div class="nav-section">
                ...
                {{-- Billing --}}
                @if (Route::has('accountant.billing.index'))
                    <a
                        href="{{ route('accountant.billing.index') }}"
                        class="nav-link {{ request()->routeIs('accountant.billing.*') ? 'active' : '' }}"
                    >
                        <span class="nav-icon">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round">
            ...
            <div class="nav-section">
                ...
                @if (Route::has('accountant.settings.edit'))
                    <a
                        href="{{ route('accountant.settings.edit') }}"

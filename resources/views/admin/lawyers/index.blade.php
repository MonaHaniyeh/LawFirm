                ...
                <div class="flex items-start justify-between">
                    ...
                    <div>
                        ...
                        <p class="mt-2 text-2xl font-semibold text-[#27633D]">
                            {{ $lawyers->getCollection()->filter(fn ($lawyer) => (bool) $lawyer->is_active)->count() }}
                        </p>
            ...
            <div class="rounded-xl border border-[#E5E2DB] bg-white p-5">
                <div class="flex items-start justify-between">
                    ...
                    <div>
                        ...
                        <p class="mt-2 text-2xl font-semibold text-[#0B0B0A]">
                            {{ $lawyers->getCollection()->filter(fn ($lawyer) => $lawyer->created_at?->isCurrentMonth())->count() }}
                        </p>
                    ...
                    <tbody class="divide-y divide-[#E5E2DB]">
                        ...
                        @forelse ($lawyers as $lawyer)
                            ...
                            @php
                                 ...
                                 *
                                 * The value must come directly from
                                 * the database/model.
                                 */
                                    ...
                                    <div class="flex items-center gap-2">
                                        ...
                                        >
                                            <path
                                                ...
                                                stroke-linejoin="round"
                                                stroke-width="1.7"
                                                d="M20 7h-3V5a2 2 0 00-2-2H9a2 2 0 00-2 2v2H4a1 1 0 00-1 1v10a2 2 0 002 2h14a2 2 0 002-2V8a1 1 0 00-1-1-1-1z"
                                            />

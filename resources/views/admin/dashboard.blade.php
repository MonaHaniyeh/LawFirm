...
@section('content')
    ...
    ========================================================== --}}
        <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div>
                ...
                <p class="mt-2 text-sm leading-6 text-gray-500">
                    Monitor and manage everything happening across the law firm.
                </p>
            </div>
        ...
        WELCOME CARD
    ========================================================== --}}
        <div class="overflow-hidden rounded-2xl border border-white/10 bg-[#11110F] shadow-sm">
            ...
            <div class="relative px-6 py-8 sm:px-8 lg:px-10">
                ...
                <div class="relative z-10 max-w-3xl">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <p class="text-xs font-semibold uppercase tracking-[0.16em] text-[#C9A96E]">
                    ...
                    <p class="mt-3 max-w-2xl text-sm leading-7 text-gray-400">
                        Here's an overview of your law firm. Review cases,
                        appointments, users, documents, billing and recent activity
        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4">
            ...
            <a href="{{ Route::has('admin.cases.index') ? route('admin.cases.index') : '#' }}"
                ...
                <div class="flex items-start justify-between">
                    ...
                    <div>
                        <p class="text-xs font-semibold uppercase tracking-[0.08em] text-gray-500">
                            Active Cases
                        </p>
                        ...
                        <p class="mt-2 text-xs font-medium text-[#3D8B5A]">
                            Currently active
                        </p>
                    </div>
            ...
            {{-- Clients --}}
            <a href="{{ Route::has('admin.clients.index') ? route('admin.clients.index') : '#' }}"
                class="group rounded-xl border border-gray-200 bg-white p-5 shadow-sm transition duration-200 hover:-translate-y-0.5 hover:border-[#C9A96E]/50 hover:shadow-md">
                <div class="flex items-start justify-between">
                    ...
                    <div>
                        ...
                        <p class="mt-3 text-3xl font-semibold text-gray-900">
                            {{ $clientsCount ?? ($stats['registered_clients'] ?? 0) }}
                        </p>
            ...
            {{-- Lawyers --}}
            <a href="{{ Route::has('admin.lawyers.index') ? route('admin.lawyers.index') : '#' }}"
                class="group rounded-xl border border-gray-200 bg-white p-5 shadow-sm transition duration-200 hover:-translate-y-0.5 hover:border-[#C9A96E]/50 hover:shadow-md">
                <div class="flex items-start justify-between">
                    ...
                    <div>
                        ...
                        <p class="mt-3 text-3xl font-semibold text-gray-900">
                            {{ $lawyersCount ?? ($stats['lawyers_on_staff'] ?? 0) }}
                        </p>
            ...
            <a href="{{ Route::has('admin.appointments.index') ? route('admin.appointments.index') : '#' }}"
                ...
                <div class="flex items-start justify-between">
                    ...
                    <div>
                        ...
                        <p class="mt-2 text-xs font-medium text-[#B98525]">
                            Need attention
                        </p>
                    </div>
...
========================================================== --}}
        <div>
            ...
            <div class="mb-4">
                ...
                <p class="mt-1 text-sm text-gray-500">
                    Quickly access the most common administrative tasks.
                </p>
            </div>
        ...
        ====================================================== --}}
                <a href="{{ route('admin.users.index') }}"
                    ...
                    <div
                        class="mx-auto flex h-11 w-11 items-center justify-center rounded-lg border border-white/10 bg-[#181815] transition duration-200 group-hover:border-[#C9A96E]/40 group-hover:bg-[#C9A96E]">
                    ...
                    <p class="mt-3 text-xs font-semibold text-gray-200 group-hover:text-white">
                        Users
                    </p>
                </a>
                ...
                <div class="flex items-center justify-between border-b border-gray-200 px-6 py-5">
                    ...
                    @if (Route::has('admin.activity.index'))
                        <a href="{{ route('admin.activity.index') }}"
                            class="text-sm font-semibold text-[#B89452] transition hover:text-[#8F713C]">
                            View all
                        </a>
                    @endif
                ...
                <div class="divide-y divide-gray-100">
                    ...
                    @forelse(($activities ?? collect())->take(6) as $activity)
                        @php
                            ...
                            $activityIcon = match ($activityType) {
                                'user', 'user_registered', 'user_created' => 'user',

                                'case', 'case_created', 'case_updated' => 'case',

                                'appointment', 'appointment_created' => 'calendar',

                                'document', 'document_uploaded' => 'document',
                        ...
                        <div class="flex items-start gap-4 px-6 py-5 transition hover:bg-[#FAF9F6]">

                            {{-- Icon --}}
                            <div class="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-[#11110F]">
                    ...
                    @empty
                        ...
                        <div class="px-6 py-14 text-center">
                            ...
                            <div class="mx-auto flex h-12 w-12 items-center justify-center rounded-full bg-[#11110F]">

                                <svg class="h-6 w-6 text-[#C9A96E]" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8"
                                        d="M12 8v4l3 2" />
                ...
                <div class="divide-y divide-gray-100">
                    ...
                    <div class="flex items-center justify-between px-6 py-5">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div class="flex h-9 w-9 items-center justify-center rounded-lg bg-[#11110F]">
        ...
        <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
            ...
            <div class="overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm">
                ...
                <div class="divide-y divide-gray-100">
                    ...
                    @forelse(($pendingAppointmentsList ?? collect())->take(4) as $appointment)
                        <div class="flex items-center justify-between gap-4 px-6 py-4 transition hover:bg-[#FAF9F6]">
                            ...
                            <div class="min-w-0">
                                ...
                                <p class="mt-1 truncate text-xs text-gray-500">
                                    With {{ $appointment->lawyer->name ?? 'Lawyer' }}
                                </p>
                            ...
                            <div class="shrink-0 text-right">
                                ...
                                <span
                                    class="mt-1 inline-flex rounded-full border border-[#B89452]/30 bg-[#B89452]/10 px-2.5 py-1 text-[10px] font-semibold text-[#8F713C]">
                                    Pending
                                </span>
                    ...
                    @empty
                        ...
                        <div class="px-6 py-10 text-center">
                            ...
                            <div class="mx-auto flex h-10 w-10 items-center justify-center rounded-full bg-[#11110F]">
                        ...
                        @if (Route::has('admin.settings.edit'))
                            <a href="{{ route('admin.settings.edit') }}"
                                ...
                                <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8"
                                        d="M19.4 15a1.7 1.7 0 00.3 1.9l.1.1-1.8 1.8-.1-.1a1.7 1.7 0 00-1.9-.3 1.7 1.7 0 00-1 1.6v.2h-2.6V20a1.7 1.7 0 00-1-1.6 1.7 1.7 0 00-1.9.3l-.1.1-1.8-1.8.1-.1a1.7 1.7 0 00.3-1.9 1.7 1.7 0 00-1.6-1H4v-2.6h.2a1.7 1.7 0 001.6-1 1.7 1.7 0 00-.3-1.9l-.1-.1 1.8-1.8.1.1a1.7 1.7 0 001.9.3 1.7 1.7 0 001-1.6V5h2.6v.2a1.7 1.7 0 001 1.6 1.7 1.7 0 001.9-.3l.1-.1 1.8 1.8-.1.1a1.7 1.7 0 00-.3 1.9 1.7 1.7 0 001.6 1h.2v2.6h-.2a1.7 1.7 0 00-1.6 1z" />
                                </svg>
